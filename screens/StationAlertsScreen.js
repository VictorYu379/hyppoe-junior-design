...
export default function StationAlertsScreen({ navigation }) {
	...
	const alerts = [
        ...
        {key: 5, name: 'Lowest to Highest Station Activity', type: 'Push Notification', rate: '30 min.'},
        {key: 6, name: 'Lowest to Highest Item Activity', type: 'Push Notification', rate: '1 hour'},
