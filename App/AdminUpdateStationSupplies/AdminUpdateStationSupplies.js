...
export default class AdminUpdateStationSupplies extends React.Component {
	...
	render() {
		...
		return <View
					...
					<View
						...
						<View
							...
							<View
								...
								<Image
									source={require("./../../assets/images/background-15.png")}
				...
				<View
					...
					<Text
						style={styles.savePreorderMenuText}>Update Station and Supplies</Text>
				</View>
			</View>
	}
}
